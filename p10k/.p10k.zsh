# Config file for Powerlevel10k with the style of robbyrussell (Catppuccin Mocha) theme from Oh My Zsh.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND='#a6e3a1'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND='#f38ba8'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=bac2de
